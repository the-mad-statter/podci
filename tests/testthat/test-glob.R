test_that("podci_glob_stnd_ped_prnt works", {
  expect_equal(
    ...
    dplyr::tibble(
      ...
      podci_tran_stnd_ped_prnt =
        c(96.3, 97.22, 67.42, 96.67, 93.33, 100, 100, 100, 100, 49.24),
      podci_sprt_stnd_ped_prnt =
        c(92.86, 78.7, 71.97, 96.67, 84.38, 100, 96.97, 89.81, 100, 28.03),
      podci_pain_stnd_ped_prnt =
        c(100, 100, 93.33, 100, 100, 100, 100, 82.22, 100, 71.11),
      podci_glob_stnd_ped_prnt =
        c(95.62, 92.79, 74.85, 93.12, 80.14, 100, 96.12, 88.84, 97.62, 45.43)
    )
  )
})
  ...
  expect_equal(
    ...
    dplyr::tibble(
      ...
      podci_pain_stnd_ped_prnt =
        c(100, 100, 93.33, 100, 100, 100, 100, 82.22, 100, 71.11),
      podci_glob_norm_ped_prnt =
        c(52.36, 48.53, 24.27, 48.98, 31.42, 58.28, 53.03, 43.19, 55.06, -15.51)
    )
  )
})
...
test_that("podci_glob_stnd_ado_prnt works", {
  expect_equal(
    ...
    dplyr::tibble(
      ...
      podci_tran_stnd_ado_prnt =
        c(100, 96.97, 100, 100, 100, 100, 100, 100, 100, 100),
      podci_sprt_stnd_ado_prnt =
        c(100, 67.36, 73.48, 100, 100, 90.28, 90.91, 93.33, 100, 100),
      podci_pain_stnd_ado_prnt =
        c(82.22, 88.89, 56.11, 77.78, 100, 88.89, 100, 100, 93.33, 100),
      podci_glob_stnd_ado_prnt =
        c(95.56, 83.1, 77.19, 94.44, 100, 93.75, 97.73, 97.29, 98.33, 100)
    )
  )
})
  ...
  expect_equal(
    ...
    dplyr::tibble(
      ...
      podci_pain_stnd_ado_prnt =
        c(82.22, 88.89, 56.11, 77.78, 100, 88.89, 100, 100, 93.33, 100),
      podci_glob_norm_ado_prnt =
        c(51.05, 34.17, 26.16, 49.55, 57.08, 48.6, 53.99, 53.4, 54.82, 57.08)
    )
  )
})
